...
public class JsSafeWebView extends WebView {
    ...
    public JsSafeWebView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public JsSafeWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void injectJavascriptInterfaces(WebView webView) {
        if (webView instanceof JsSafeWebView) {
            injectJavascriptInterfaces();
        }
    }
    ...
    private class WebChromeClientEx extends WebChromeClient {
        ...
        public final boolean onJsPrompt(WebView view, String url, String message,
            ...
            if (view instanceof JsSafeWebView) {
